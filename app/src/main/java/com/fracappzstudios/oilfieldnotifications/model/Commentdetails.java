...
public class Commentdetails {
    ...
    @Expose
    private List<CreateEventUserId> createEventUserId = null;
    @SerializedName("PeopelDirdetail")
    @Expose
    ...
    public List<CreateEventUserId> getCreateEventUserId() {
        return createEventUserId;
    }

    public void setCreateEventUserId(List<CreateEventUserId> createEventUserId) {
